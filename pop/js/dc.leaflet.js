dc.leafletChart = function(_chart) {
  ...
  var _tiles=function(map) {
    L.tileLayer('http://otile2.mqcdn.com/tiles/1.0.0/osm/{z}/{x}/{y}.png', {
	  ...
	  dens = 'http://b.tiles.mapbox.com/v3/oliviercecchi.z0i442t9/{z}/{x}/{y}.png'
      infra = 'http://b.tiles.mapbox.com/v3/oliviercecchi.uh5pcik9/{z}/{x}/{y}.png'
	 

        var basem = new L.TileLayer(baseMap),
            inf = new L.TileLayer(infra),
			density = new L.TileLayer(dens),
